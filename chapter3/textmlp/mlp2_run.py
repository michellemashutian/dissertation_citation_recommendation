...
from mlp2_model import Config, CitationRecNet
            ...
            for j in range(STEPS):
                ...
                if i == 4:
                    ...
                    if min_cross > model_loss:
                        ...
                        print("/epoch_%s-batch_%s-cross_entropy_%s" % (i, j, model_loss))
                        output1 = open((args.result_path + 'result-mlp2-'+args.train+'-'+args.test), 'w')
                        output2 = open((args.result_path + 'vector-mlp2-'+args.train+'-'+args.test), 'w')
